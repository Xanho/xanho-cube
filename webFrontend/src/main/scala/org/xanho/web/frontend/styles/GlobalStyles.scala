...
object GlobalStyles extends StyleSheet.Inline {
  ...
  val global = style(
    ...
    unsafeRoot("h1")(
      position.relative,
      DefaultFonts.acumin(FontWeight.SemiBold),
      paddingTop(7 rem),
    ...
    unsafeRoot("h2")(
      DefaultFonts.acumin(FontWeight.Regular),
      marginBottom(2 rem),
      lineHeight(1.2),
      fontSize(2.5 rem),
      wordWrap.breakWord,
    ...
    unsafeRoot("h3")(
      DefaultFonts.acumin(FontWeight.ExtraLight),
      marginTop(4.5 rem),
    ...
    unsafeRoot("blockquote")(
      DefaultFonts.acumin(FontWeight.ExtraLight, FontStyle.Italic),
      position.relative,
